...
public class ExtendedCab extends Cab
{
	...
	//returns array list of cabs
	public ArrayList<ExtendedCab> getCl()
	{
		return cl;
	}
	//sets the array list
	public void setCl(ArrayList<ExtendedCab> cl2)
	{
			cl = cl2;
	...
	public ExtendedCab(String name, double milesPG,double tankSize)
	{
		cabName = name;
		MPG = milesPG;
		TANK_SIZE = tankSize;
